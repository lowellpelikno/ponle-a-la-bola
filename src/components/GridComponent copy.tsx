...
interface Props {
  onRequestForm: () => void;
  clickedItems: GridItem[];
  setClickedItems: React.Dispatch<React.SetStateAction<GridItem[]>>;
}
...
const GridComponent: React.FC<Props> = ({ onRequestForm }) => {
...
const totalCost = clickedItems.length * 20;
  ...
  return (
    ...
    <h2>🆕 Números seleccionados</h2>
        ...
        <button onClick={onRequestForm}>Registrar datos</button>
